...
describe("Test for resizeFunc", () => {
  ...
  it("should return error if image name does not exist", async () => {
    ...
    getfun(
      "http://localhost:3000/photo?name=noImage&width=800&height=1800"
  ...
  it("should return error if width is not a number ", async () => {
    ...
    getfun(
      "http://localhost:3000/photo?name=icelandwaterfall&width=number&height=1800"
    ).then((res) => console.log(res))
  })
  ...
  it("should return error if height is not a number ", async () => {
    ...
    getfun(
      "http://localhost:3000/photo?name=icelandwaterfall&width=800&height=number"
    ).then((res) => console.log(res))
  })
  ...
  it("should return error if image path not found ", async () => {
    ...
    getfun("http://localhost:3000/photo?name=&width=800&height=800").then(
      (res) => console.log(res)
    )
  })
})
